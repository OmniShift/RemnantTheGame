...
io.on('connection', function (socket) {
    ...
    socket.on('share new game data', function(roomID, sCardPiles, refCardsLength) {
        ...
        pool.query('SELECT * FROM "GRIDs" WHERE idname = $1;', [roomID]).then(res => {
            ...
            var territoryStates = ["[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]","[]"];
            var cardStates = [];
            for (var i = 0; i < refCardsLength; i++) {
                cardStates.push("[]");
            }
            socket.broadcast.to(roomID).emit('return game data', roomID, pIDs, pCommander, pKingdom, cardPiles);
            pool.query(
                'UPDATE "GRIDs" SET cardpiles = $1, territorystates = $2, cardstates = $3, playerturn = 0 WHERE idname = $4;', [
                    cardPiles, territoryStates, cardStates, roomID
                ], function (err, data) {
                    if (err) {
    ...
    socket.on('request save game', function(roomID, sDrawPile, sPCards, sTerritoryStates, sStageOfWar) {
        socket.breadcast.to(roomID).emit('save game data request');
        pool.query(
            'UPDATE "GRIDs" SET cardpiles[0] = $1, cardpiles[$2] = $3, territorystates = $4, stageofwar = $5, playerturn = 0 WHERE idname = $6;', [
                sDrawPile, playerIndex, sPCards, sTerritoryStates, sStageOfWar, roomID
            ], function (err, data) {
                if (err) {
                    throw new Error('Error updating hands of game room ' + roomID);
                }
    ...
    socket.on('return save game data', function(roomID, sPCards) {
        pool.query(
            'UPDATE "GRIDs" SET cardpiles[$1] = $2 WHERE idname = $3;', [
                playerIndex, sPCards, roomID
            ], function (err, data) {
                if (err) {
                    throw new Error('Error updating hands of game room ' + roomID);
                }
